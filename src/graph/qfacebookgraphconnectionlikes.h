...
class QFacebookGraphConnectionLikes : public QFacebookGraphConnectionMediaBase
{
    Q_OBJECT
public:
    explicit QFacebookGraphConnectionLikes(QString fbid = QString::null, QObject *parent = 0);
