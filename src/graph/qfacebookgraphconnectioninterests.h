...
class QFacebookGraphConnectionInterests : public QFacebookGraphConnectionMediaBase
{
    Q_OBJECT
public:
    explicit QFacebookGraphConnectionInterests(QString fbid = QString::null, QObject *parent = 0);
