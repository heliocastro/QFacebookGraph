...
class QFacebookGraphConnectionBooks : public QFacebookGraphConnectionMediaBase
{
    Q_OBJECT
public:
    explicit QFacebookGraphConnectionBooks(QString fbid = QString::null, QObject *parent = 0);
