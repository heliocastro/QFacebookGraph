...
class QFacebookGraphConnectionTelevision : public QFacebookGraphConnectionMediaBase
{
    Q_OBJECT
public:
    explicit QFacebookGraphConnectionTelevision(QString fbid = QString::null, QObject *parent = 0);
